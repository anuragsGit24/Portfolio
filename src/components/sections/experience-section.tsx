    ...
    <SectionWrapper id="experience" className="bg-secondary/50">
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        {EXPERIENCE.map((job, index) => (
          <div key={job.company} className="relative mb-12 group">
            <div className="flex items-center">
              <div className="z-10 bg-background p-2 rounded-full border-2 border-primary absolute left-1/2 -translate-x-1/2 group-hover:scale-125 transition-transform duration-300">
